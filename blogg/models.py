...
class Content(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='content', on_delete=models.CASCADE) 
...
class Image(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='imageblog', on_delete=models.CASCADE) 
...
class Quote(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='quote', on_delete=models.CASCADE) 
...
class CodeBlock(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='codeblock', on_delete=models.CASCADE) 
...
class Video(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='video', on_delete=models.CASCADE) 
    url = models.URLField()
...
class Ad(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='ad', on_delete=models.CASCADE) 
...
class List(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='list', on_delete=models.CASCADE) 
...
class Title(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='titleblog', on_delete=models.CASCADE) 
    title = models.CharField(max_length=255)
...
class Subtitle(models.Model):
    blog = models.ForeignKey(Blog, null = True,related_name='subtitle', on_delete=models.CASCADE) 
